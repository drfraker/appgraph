...
1. Call `appgraph_overview` at the beginning of a cross-layer feature, unfamiliar-area investigation, or refactor. If `staleness.newerSourceFiles` is non-zero and current results matter, call `appgraph_refresh` once.
