...
- Use `appgraph_find` to resolve a route, class, method, table, column, view (dotted Blade name like `notes.show`), event, or job and inspect its direct edges. Anchor on exact identifiers; multi-word targets match identifiers containing every word, but prose sentences will not resolve.
